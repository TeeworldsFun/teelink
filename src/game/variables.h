...
#undef GAME_VARIABLES_H // this file will be included several timesç
...
MACRO_CONFIG_STR(HCUpdate, hc_update, 255, HCLIENT_VERSION, CFGFLAG_CLIENT|CFGFLAG_SAVE, "Last update version") //H-Client
...
MACRO_CONFIG_STR(UiServerGameType, ui_server_game_type, 64, "DM", CFGFLAG_CLIENT|CFGFLAG_SAVE, "Interface server game type")
...
MACRO_CONFIG_INT(UiColorAlpha, ui_color_alpha, 0, 0, 255, CFGFLAG_CLIENT|CFGFLAG_SAVE, "Interface alpha")
...
/** MineTee **/
MACRO_CONFIG_INT(SvGameMode, sv_gamemode, 0, 0, 1, CFGFLAG_SERVER, "MineTee GameMode")
...
MACRO_CONFIG_INT(SvNight, sv_night, -1, -1, 4, CFGFLAG_SERVER, "Night Level")
MACRO_CONFIG_INT(SvNightTime, sv_night_tme, 300, 0, 9999, CFGFLAG_SERVER, "Night time")

/** H-CLIENT **/
MACRO_CONFIG_INT(UiSubPage, ui_subpage, 11, 0, 14, CFGFLAG_CLIENT|CFGFLAG_SAVE, "Interface Subpage") //H-Client
MACRO_CONFIG_INT(HC3D, hc_3d, 0, 0, 1, CFGFLAG_CLIENT|CFGFLAG_SAVE, "Enable 3D view") //H-Client
